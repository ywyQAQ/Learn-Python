...
# super()的另一个常见用法出现在覆盖Python特殊方法的代码中，比如：
class Proxy:
    ...
    def __setattr__(self, __name: str, __value: Any) -> None:
        if __name.startswith('_'):
            ...
            setattr(self._obj, __name, __value)
...
# Raymond Hettinger为此写了一篇非常好的文章 “Python’s super() Considered Super!” ， 
